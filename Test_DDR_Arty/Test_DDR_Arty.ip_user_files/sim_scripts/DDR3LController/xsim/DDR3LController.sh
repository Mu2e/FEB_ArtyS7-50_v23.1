...
#
# Script generated by Vivado on Tue May 30 16:49:57 -0500 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : DDR3LController.sh
...
#
# Usage        : DDR3LController.sh
#                DDR3LController.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DDR3LController.sh [-reset_run]
#                DDR3LController.sh [-reset_log]
#                DDR3LController.sh [-help]
#
...
# script info
echo -e "DDR3LController.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DDR3LController.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DDR3LController xil_defaultlib.DDR3LController xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DDR3LController -key {Behavioral:sim_1:Functional:DDR3LController} -tclbatch cmd.tcl -protoinst "protoinst_files/TestDDR.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DDR3LController.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DDR3LController.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DDR3LController.sh [-help]\n\
Usage: DDR3LController.sh [-step]\n\
Usage: DDR3LController.sh [-lib_map_path]\n\
Usage: DDR3LController.sh [-reset_run]\n\
Usage: DDR3LController.sh [-reset_log]\n\
Usage: DDR3LController.sh [-keep_index]\n\
Usage: DDR3LController.sh [-noclean_files]\n\n\
