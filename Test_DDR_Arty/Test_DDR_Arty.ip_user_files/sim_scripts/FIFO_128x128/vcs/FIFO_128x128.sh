...
#
# Script generated by Vivado on Wed May 31 12:22:20 -0500 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : FIFO_128x128.sh
...
#
# Usage        : FIFO_128x128.sh
#                FIFO_128x128.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                FIFO_128x128.sh [-reset_run]
#                FIFO_128x128.sh [-reset_log]
#                FIFO_128x128.sh [-help]
#
...
#                script (type 'FIFO_128x128.sh -help' for more information).
#
...
# script info
echo -e "FIFO_128x128.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./FIFO_128x128.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.FIFO_128x128 xil_defaultlib.glbl -o FIFO_128x128_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./FIFO_128x128_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key FIFO_128x128_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc FIFO_128x128_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./FIFO_128x128.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: FIFO_128x128.sh [-help]\n\
Usage: FIFO_128x128.sh [-step]\n\
Usage: FIFO_128x128.sh [-lib_map_path]\n\
Usage: FIFO_128x128.sh [-reset_run]\n\
Usage: FIFO_128x128.sh [-reset_log]\n\
Usage: FIFO_128x128.sh [-keep_index]\n\
Usage: FIFO_128x128.sh [-noclean_files]\n\n\
