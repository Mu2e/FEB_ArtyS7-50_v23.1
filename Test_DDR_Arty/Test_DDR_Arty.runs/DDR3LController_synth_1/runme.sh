...
HD_PWD='C:/v23.1/Test_DDR_Arty/Test_DDR_Arty.runs/DDR3LController_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR3LController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDR3LController.tcl
