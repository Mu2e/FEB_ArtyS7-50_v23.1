...
HD_PWD='C:/v23.1/Test_DDR_Arty/Test_DDR_Arty.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TestDDR_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TestDDR_wrapper.tcl -notrace
