...
HD_PWD='C:/v23.1/Test_DDR_Arty/Test_DDR_Arty.runs/TestDDR_TestDDR_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestDDR_TestDDR_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestDDR_TestDDR_top_0_0.tcl
