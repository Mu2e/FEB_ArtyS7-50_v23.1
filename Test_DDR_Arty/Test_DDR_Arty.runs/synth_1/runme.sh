...
HD_PWD='C:/v23.1/Test_DDR_Arty/Test_DDR_Arty.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestDDR_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestDDR_wrapper.tcl
