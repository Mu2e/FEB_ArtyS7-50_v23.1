...
HD_PWD='C:/v23.1/FEB_fabric/FEB_fabric.runs/DDR_ila_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR_ila_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDR_ila_0.tcl
