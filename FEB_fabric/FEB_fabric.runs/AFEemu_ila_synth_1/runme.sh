...
HD_PWD='C:/v23.1/FEB_fabric/FEB_fabric.runs/AFEemu_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AFEemu_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AFEemu_ila.tcl
