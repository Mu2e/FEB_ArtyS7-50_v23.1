...
HD_PWD='C:/v23.1/FEB_fabric/FEB_fabric.runs/AFE_DataPath_ila2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AFE_DataPath_ila2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AFE_DataPath_ila2.tcl
