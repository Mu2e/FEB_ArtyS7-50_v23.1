...
HD_PWD='C:/v23.1/FEB_fabric/FEB_fabric.runs/Trigger_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Trigger_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Trigger_ila.tcl
