...
HD_PWD='C:/v23.1/FEB_fabric/FEB_fabric.runs/LVDSTxBuff_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LVDSTxBuff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LVDSTxBuff.tcl
