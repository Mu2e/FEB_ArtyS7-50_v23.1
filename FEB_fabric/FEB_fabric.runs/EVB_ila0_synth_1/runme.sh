...
HD_PWD='C:/v23.1/FEB_fabric/FEB_fabric.runs/EVB_ila0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EVB_ila0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EVB_ila0.tcl
