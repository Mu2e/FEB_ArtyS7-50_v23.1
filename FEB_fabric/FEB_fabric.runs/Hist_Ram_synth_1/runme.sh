...
HD_PWD='C:/v23.1/FEB_fabric/FEB_fabric.runs/Hist_Ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Hist_Ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Hist_Ram.tcl
