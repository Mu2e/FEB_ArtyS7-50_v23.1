...
HD_PWD='C:/v23.1/FEB_fabric/FEB_fabric.runs/iuCD_FIFO_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iuCD_FIFO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iuCD_FIFO.tcl
