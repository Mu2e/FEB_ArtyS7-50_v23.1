...
HD_PWD='C:/v23.1/FEB_fabric/FEB_fabric.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FEB_fabric.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FEB_fabric.tcl -notrace
