...
HD_PWD='C:/v23.1/FEB_fabric/FEB_fabric.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FEB_fabric.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FEB_fabric.tcl
