...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.SCFIFO_32x256 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.SCFIFO_32x256 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log SCFIFO_32x256_sc.so .tmp_log xcelium_lib waves.shm c.obj)
