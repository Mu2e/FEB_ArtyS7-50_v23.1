...
#
# Script generated by Vivado on Thu Jun 01 16:04:12 -0500 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : LVDSTxBuff.sh
...
#
# Usage        : LVDSTxBuff.sh
#                LVDSTxBuff.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                LVDSTxBuff.sh [-reset_run]
#                LVDSTxBuff.sh [-reset_log]
#                LVDSTxBuff.sh [-help]
#
...
# script info
echo -e "LVDSTxBuff.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./LVDSTxBuff.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot LVDSTxBuff xil_defaultlib.LVDSTxBuff xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim LVDSTxBuff -key {Behavioral:sim_1:Functional:LVDSTxBuff} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb LVDSTxBuff.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./LVDSTxBuff.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: LVDSTxBuff.sh [-help]\n\
Usage: LVDSTxBuff.sh [-step]\n\
Usage: LVDSTxBuff.sh [-lib_map_path]\n\
Usage: LVDSTxBuff.sh [-reset_run]\n\
Usage: LVDSTxBuff.sh [-reset_log]\n\
Usage: LVDSTxBuff.sh [-keep_index]\n\
Usage: LVDSTxBuff.sh [-noclean_files]\n\n\
