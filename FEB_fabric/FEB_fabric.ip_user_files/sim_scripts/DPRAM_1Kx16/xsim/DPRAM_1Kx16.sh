...
#
# Script generated by Vivado on Thu Jun 01 16:03:51 -0500 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : DPRAM_1Kx16.sh
...
#
# Usage        : DPRAM_1Kx16.sh
#                DPRAM_1Kx16.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DPRAM_1Kx16.sh [-reset_run]
#                DPRAM_1Kx16.sh [-reset_log]
#                DPRAM_1Kx16.sh [-help]
#
...
# script info
echo -e "DPRAM_1Kx16.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DPRAM_1Kx16.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DPRAM_1Kx16 xil_defaultlib.DPRAM_1Kx16 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DPRAM_1Kx16 -key {Behavioral:sim_1:Functional:DPRAM_1Kx16} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DPRAM_1Kx16.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DPRAM_1Kx16.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DPRAM_1Kx16.sh [-help]\n\
Usage: DPRAM_1Kx16.sh [-step]\n\
Usage: DPRAM_1Kx16.sh [-lib_map_path]\n\
Usage: DPRAM_1Kx16.sh [-reset_run]\n\
Usage: DPRAM_1Kx16.sh [-reset_log]\n\
Usage: DPRAM_1Kx16.sh [-keep_index]\n\
Usage: DPRAM_1Kx16.sh [-noclean_files]\n\n\
