...
#                script (type 'DPRAM_1Kx16.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.DPRAM_1Kx16 xil_defaultlib.glbl -o DPRAM_1Kx16_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./DPRAM_1Kx16_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key DPRAM_1Kx16_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc DPRAM_1Kx16_simv.daidir vcs_lib c.obj)
