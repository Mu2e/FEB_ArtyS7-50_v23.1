...
#
# Script generated by Vivado on Thu Jun 01 16:03:31 -0500 2023
...
#
# Usage        : AFEemu.sh
#                AFEemu.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                AFEemu.sh [-reset_run]
#                AFEemu.sh [-reset_log]
#                AFEemu.sh [-help]
#
...
# script info
echo -e "AFEemu.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./AFEemu.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot AFEemu xil_defaultlib.AFEemu xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim AFEemu -key {Behavioral:sim_1:Functional:AFEemu} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb AFEemu.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./AFEemu.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: AFEemu.sh [-help]\n\
Usage: AFEemu.sh [-step]\n\
Usage: AFEemu.sh [-lib_map_path]\n\
Usage: AFEemu.sh [-reset_run]\n\
Usage: AFEemu.sh [-reset_log]\n\
Usage: AFEemu.sh [-keep_index]\n\
Usage: AFEemu.sh [-noclean_files]\n\n\
