...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot AFE_DataPath_ila0 xil_defaultlib.AFE_DataPath_ila0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim AFE_DataPath_ila0 -key {Behavioral:sim_1:Functional:AFE_DataPath_ila0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb AFE_DataPath_ila0.wdb xsim.dir libdpi.so)
