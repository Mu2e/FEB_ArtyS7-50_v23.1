...
#
# Script generated by Vivado on Thu Jun 01 16:02:57 -0500 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : AFE_DataPath_ila0.sh
...
#
# Usage        : AFE_DataPath_ila0.sh
#                AFE_DataPath_ila0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                AFE_DataPath_ila0.sh [-reset_run]
#                AFE_DataPath_ila0.sh [-reset_log]
#                AFE_DataPath_ila0.sh [-help]
#
...
#                script (type 'AFE_DataPath_ila0.sh -help' for more information).
#
...
# script info
echo -e "AFE_DataPath_ila0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./AFE_DataPath_ila0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../FEB_fabric.gen/sources_1/ip/AFE_DataPath_ila0/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.AFE_DataPath_ila0 xil_defaultlib.glbl -o AFE_DataPath_ila0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./AFE_DataPath_ila0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key AFE_DataPath_ila0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc AFE_DataPath_ila0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./AFE_DataPath_ila0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: AFE_DataPath_ila0.sh [-help]\n\
Usage: AFE_DataPath_ila0.sh [-step]\n\
Usage: AFE_DataPath_ila0.sh [-lib_map_path]\n\
Usage: AFE_DataPath_ila0.sh [-reset_run]\n\
Usage: AFE_DataPath_ila0.sh [-reset_log]\n\
Usage: AFE_DataPath_ila0.sh [-keep_index]\n\
Usage: AFE_DataPath_ila0.sh [-noclean_files]\n\n\
