...
#
# Script generated by Vivado on Thu Jun 01 16:04:30 -0500 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : Trigger_ila.sh
...
#
# Usage        : Trigger_ila.sh
#                Trigger_ila.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Trigger_ila.sh [-reset_run]
#                Trigger_ila.sh [-reset_log]
#                Trigger_ila.sh [-help]
#
...
#                script (type 'Trigger_ila.sh -help' for more information).
#
...
# script info
echo -e "Trigger_ila.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Trigger_ila.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../FEB_fabric.gen/sources_1/ip/Trigger_ila/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Trigger_ila xil_defaultlib.glbl -o Trigger_ila_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Trigger_ila_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Trigger_ila_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Trigger_ila_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Trigger_ila.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Trigger_ila.sh [-help]\n\
Usage: Trigger_ila.sh [-step]\n\
Usage: Trigger_ila.sh [-lib_map_path]\n\
Usage: Trigger_ila.sh [-reset_run]\n\
Usage: Trigger_ila.sh [-reset_log]\n\
Usage: Trigger_ila.sh [-keep_index]\n\
Usage: Trigger_ila.sh [-noclean_files]\n\n\
