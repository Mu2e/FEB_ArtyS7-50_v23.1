...
#                script (type 'Hist_Ram.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Hist_Ram xil_defaultlib.glbl -o Hist_Ram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Hist_Ram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Hist_Ram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Hist_Ram_simv.daidir vcs_lib c.obj)
