...
#
# Script generated by Vivado on Thu Jun 01 16:04:06 -0500 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : Hist_Ram.sh
...
#
# Usage        : Hist_Ram.sh
#                Hist_Ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Hist_Ram.sh [-reset_run]
#                Hist_Ram.sh [-reset_log]
#                Hist_Ram.sh [-help]
#
...
# script info
echo -e "Hist_Ram.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Hist_Ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Hist_Ram xil_defaultlib.Hist_Ram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Hist_Ram -key {Behavioral:sim_1:Functional:Hist_Ram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Hist_Ram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Hist_Ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Hist_Ram.sh [-help]\n\
Usage: Hist_Ram.sh [-step]\n\
Usage: Hist_Ram.sh [-lib_map_path]\n\
Usage: Hist_Ram.sh [-reset_run]\n\
Usage: Hist_Ram.sh [-reset_log]\n\
Usage: Hist_Ram.sh [-keep_index]\n\
Usage: Hist_Ram.sh [-noclean_files]\n\n\
