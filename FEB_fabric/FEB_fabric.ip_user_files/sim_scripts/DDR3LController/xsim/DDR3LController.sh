...
#
# Script generated by Vivado on Thu Jun 01 16:31:51 -0500 2023
...
simulate()
{
  xsim DDR3LController -key {Behavioral:sim_1:Functional:DDR3LController} -tclbatch cmd.tcl -log simulate.log
}
