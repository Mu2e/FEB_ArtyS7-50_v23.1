...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../FEB_fabric.gen/sources_1/ip/AFEemu_ila/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.AFEemu_ila xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.AFEemu_ila -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log AFEemu_ila_sc.so .tmp_log xcelium_lib waves.shm c.obj)
