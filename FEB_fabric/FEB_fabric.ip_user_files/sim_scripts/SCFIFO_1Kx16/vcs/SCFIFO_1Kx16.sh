...
#
# Script generated by Vivado on Thu Jun 01 16:04:18 -0500 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : SCFIFO_1Kx16.sh
...
#
# Usage        : SCFIFO_1Kx16.sh
#                SCFIFO_1Kx16.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SCFIFO_1Kx16.sh [-reset_run]
#                SCFIFO_1Kx16.sh [-reset_log]
#                SCFIFO_1Kx16.sh [-help]
#
...
#                script (type 'SCFIFO_1Kx16.sh -help' for more information).
#
...
# script info
echo -e "SCFIFO_1Kx16.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SCFIFO_1Kx16.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.SCFIFO_1Kx16 xil_defaultlib.glbl -o SCFIFO_1Kx16_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./SCFIFO_1Kx16_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key SCFIFO_1Kx16_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc SCFIFO_1Kx16_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./SCFIFO_1Kx16.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: SCFIFO_1Kx16.sh [-help]\n\
Usage: SCFIFO_1Kx16.sh [-step]\n\
Usage: SCFIFO_1Kx16.sh [-lib_map_path]\n\
Usage: SCFIFO_1Kx16.sh [-reset_run]\n\
Usage: SCFIFO_1Kx16.sh [-reset_log]\n\
Usage: SCFIFO_1Kx16.sh [-keep_index]\n\
Usage: SCFIFO_1Kx16.sh [-noclean_files]\n\n\
